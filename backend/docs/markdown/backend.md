...
Therefore, our team decided to dedicate most of our time to refactoring the architecture of the backend in hopes of reducing the degree of technical debt in the future. We settled upon a layered architecture, which would delegate functional responsibilities that span across the layers. Overall, we believe that this would ease the process of modifying anything in the backend.
